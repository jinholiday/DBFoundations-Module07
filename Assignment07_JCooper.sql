...
-- 2022-05-30,JamesCooper,Created File
--**************************************************************************--
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment07DB_JamesCooper')
	 Begin 
	  Alter Database [Assignment07DB_JamesCooper] set Single_user With Rollback Immediate;
	  Drop Database Assignment07DB_JamesCooper;
	 End
	Create Database Assignment07DB_JamesCooper;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment07DB_JamesCooper;
...
Select Top 1000000
	...
	,p.InventoryDate
	,p.InventoryCount
	,IIF (MONTH(p.InventoryDate)=1, 0,Lag(p.InventoryCount) Over (Order By p.ProductName)) as PreviousMonthCount
...
go
Create or Alter Function fProductInventoriesWithPreviousMonthCountsWithKPIs (@CountVsPreviosCountKPI Integer)
...
Where CountVsPreviousCountKPI = @CountVsPreviosCountKPI
